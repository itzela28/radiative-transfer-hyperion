...
def get_stellar_params(model = None, dist = 321 * units.pc):
    """
    Retrieve stellar parameters for U Cam Table 2.1 
    Arguments:
    ...
    #fnu = ((lnu * units.erg / units.s) / (4 * np.pi * dist.to('m')**2)).to('Jy')
...
def get_SED(IRASPSC = ['12427+4542']):
    """
