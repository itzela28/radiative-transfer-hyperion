#Blackbody with different temperatures T=[3000,9000,18000]
...
class PowerLawEnvelope():
    ...
    #env.rho_0 = 2           #only needed is env.mass is not given
    ...
    sed.set_wavelength_range(100, 0.3, 1500.) #from 0.3 to 1500 microns, 100 wavelength
    sed.set_track_origin('basic')

    # Set number of photons
    #if the density grid is optically thin, initial should be
    #at least equal to the number of cells in the grid.
    #if the optical depth is larger, initial should be
    #10 or 100 times the number of cells
    ...
    # Write out file
    m.write('sed_t18.rtin')
    m.run('sed_t18.rtout', mpi=True)