...
def table2_1():
    ...
    Rs = [0.0204, 0.0251, 0.0260, 0.0552, 0.1150, 0.1326, 0.2957] #shell radius
    dR = [0.0023, 0.0026, 0.0013, 0.0149, 0.0131, 0.0155, 0.0856] #shell thickness

    t = Table([ID, IRASPSC, Lbol_Kastner, Lbol_bib, Teff, Mass, Rs, dR], \
              names = ('ID', 'IRASPSC', 'Lbol_Kastner', 'Lbol_bib', 'Teff', 'Mass', 'Rs', 'dR'), \
              units = ('', '', 'L_sun', 'L_sun', 'K', 'M_sun', 'pc', 'pc'))
